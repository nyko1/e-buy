                        ...
                        <tbody>
                            <?php $__currentLoopData = $sliders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><img src="/storage/slider_images/<?php echo e($slider->slider_image); ?>" alt=""></td>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <button class="btn btn-outline-success" onclick="window.location='<?php echo e(url('/activer_slider/'.$slider->id)); ?>'">Activer</button>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.appadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\E_Commerce\resources\views/admin/sliders.blade.php ENDPATH**/ ?>