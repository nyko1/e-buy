	...
	<div class="limiter">
		...
		<div class="container-login100" style="background-image: url('frontend/login/images/bg-01.jpg');">
			<div class="wrap-login100">
				...
				<?php endif; ?>
				<form action="<?php echo e(url('/creer_compte')); ?>" method="POST" class="login100-form validate-form">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="<?php echo e(URL::to('/client_login')); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\E_Commerce\resources\views/client/signup.blade.php ENDPATH**/ ?>