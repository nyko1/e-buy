<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="{{URL::to('/')}}">NykoTech</a>
      ...
      <li class="nav-item active"><a href="{{URL::to('/shop')}}" class="nav-link">shop</a></li>
          ...
          @if (Session::has('client'))
            <li class="nav-item active"><a href="{{URL::to('/logout')}}" class="nav-link"><span class="fa-out"></span> Logout</a></li>
          @else
            <li class="nav-item active"><a href="{{URL::to('/client_login')}}" class="nav-link"><span class="fa-user"></span> Login</a></li>
          @endif
