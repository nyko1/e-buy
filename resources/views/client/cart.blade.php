						  ...
						  <thead class="thead-primary">
							...
							<tbody>
								@foreach ($products as $product)
									<tr class="text-center">
										<td class="product-remove"><a href="{{URL::to('/retirer_produit/'.$product['product_id'])}}"><span class="ion-ios-close"></span></a></td>
										...
										<form action="{{ '/modifier_qte/'. $product['product_id']}}" method="POST">
											{{ csrf_field() }}
											<td class="quantity">
			  ...
			  <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
				  <div class="cart-total mb-3">
					  ...
					  <p class="d-flex total-price">
						  <span>Total</span>
						  <span>{{Session::has('cart')? Session::get('cart')->totalPrice:'-'}} FCFA</span>
					  </p>
				  </div>
